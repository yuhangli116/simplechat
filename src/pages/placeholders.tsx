...
export const Welfare = () => <PlaceholderPage title="福利中心 (开发中)" desc="签到、任务、领取星石" />;
...
export const Records = () => <PlaceholderPage title="星石记录 (开发中)" desc="查看你的消费和充值记录" withPagination />;
